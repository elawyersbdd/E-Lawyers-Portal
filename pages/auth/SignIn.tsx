  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!user.emailVerified) {
        // If not verified, sign out and redirect to verification page
        await signOut(auth);
        navigate(RoutePath.VERIFY_EMAIL, { state: { email } });
      } else {
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <form onSubmit={handleSubmit} className="mt-10 w-full space-y-6">
              ...
              <div className="flex items-center justify-between px-1">
                  ...
                  <Link to={RoutePath.FORGOT_PASSWORD} className="text-xs font-semibold text-indigo-600 hover:text-indigo-500 transition-colors hover:underline decoration-2 underline-offset-2">Forgot password?</Link>
              </div>
